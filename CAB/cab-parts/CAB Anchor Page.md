...
The primary entry point for an anchor: `{NAME}.md`. Contains the breadcrumb, a dispatch table, and optionally a heading with description property and additional content.
...
:>> [[kmr]] → [[prj]] → [[PP]] → [task-runner](hook://p/task-runner)

# TSK — Task Runner


| -[[TSK]]-                   | +: scheduling and running deferred tasks                                                                                                  |
| --------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
...
- **Top-right cell** — `+:` followed by a short description
